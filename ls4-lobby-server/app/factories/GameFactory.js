...
exports.startGameServer = function(players, gameServerPort, path, map, lobbyType) {
    if (players != null){
        ...
        var isBotGame = lobbyType && lobbyType.includes("BOT");
        var team1Players = [];
        var team2Players = [];
        ...
        while (count <= max){
            ...
            playerObj["runes"] = new Object();
            playerObj.rank = "DIAMOND";
            playerObj.name = players[count].name;
            ...
            playerObj.playerId = count + 1;
            
            if (playerObj.team === "BLUE") {
                team1Players.push(playerObj);
            } else {
                team2Players.push(playerObj);
            }
            count++;
        }
        ...
        if (isBotGame) {
            ...
            for (var i = team1Players.length; i < 5; i++) {
                var bot = new Object();
                bot["runes"] = new Object();
                bot.rank = "DIAMOND";
                bot.name = "Blue" + botNames[i];
            ...
            for (var i = team2Players.length; i < 5; i++) {
                var bot = new Object();
                bot["runes"] = new Object();
                bot.rank = "DIAMOND";
                bot.name = "Red" + botNames[i];
                bot.champion = dictChamps[botChamps[i]];
                bot.team = "PURPLE";
                bot.skin = 0;
                bot.summoner1 = "FLASH";
        ...
        objToJSON.players = team1Players.concat(team2Players);
