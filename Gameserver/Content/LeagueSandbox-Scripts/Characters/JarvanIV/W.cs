...
{
    /// <summary>
    /// Jarvan IV W - Golden Aegis
    /// 金色护盾
    /// </summary>
    public class JarvanIVW : ISpellScript
    {
        ...
        public void OnSpellPostCast(Spell spell)
        {
            ...
            // 持续时间: 3秒
            AddBuff("JarvanIVW", 3f, 1, spell, owner, owner);

            AddParticle(owner, owner, "JarvanIVW_cas", owner.Position);
        }
    }
}
