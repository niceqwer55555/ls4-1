...
{
    /// <summary>
    /// Pyke R - Death from Below
    /// 下潜并斩杀低血量敌人
    /// </summary>
    public class PykeR : ISpellScript
    {
        ...
        public void OnSpellPostCast(Spell spell)
        {
            ...
            // 物理伤害: 250/350/450 (+2.0 bonus AD)
            float[] baseDamage = { 250f, 350f, 450f };
            float bonusAd = owner.Stats.AttackDamage.Total - owner.Stats.AttackDamage.BaseValue;
            float damage = baseDamage[spell.CastInfo.SpellLevel - 1] + bonusAd * 2.0f;
            ...
            AddParticle(owner, owner, "PykeR_cas", targetPos);
        }
    }
}
