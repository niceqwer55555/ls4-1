...
namespace Spells
{
    ...
    public class EzrealArcaneShiftMissile : ISpellScript
    {
        ...
        public void TargetExecute(Spell spell, AttackableUnit target, SpellMissile missile, SpellSector sector)
        {
            ...
            float ad = spell.CastInfo.Owner.Stats.AttackDamage.Total * 0.75f;
            float ap = spell.CastInfo.Owner.Stats.AbilityPower.Total * 0.5f;
            target.TakeDamage(spell.CastInfo.Owner, baseDamage[spell.CastInfo.SpellLevel - 1] + ad + ap,
