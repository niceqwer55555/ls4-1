...
namespace Spells
{
    public class ZedShadowBasicAttack : ISpellScript
    {
        ...
        {
            var Zed = spell.CastInfo.Owner as Champion;
            if (Zed != null && target != null)
            {
                float damage = Zed.Stats.AttackDamage.FlatBonus * 0.5f;
