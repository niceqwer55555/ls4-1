...
{
    /// <summary>
    /// Rumble Q - Electro-Harpoon
    /// 发射 electro-harp束烧毁敌人
    /// </summary>
    public class RumbleQ : ISpellScript
    {
        ...
        public void OnSpellPostCast(Spell spell)
        {
            ...
            // 每秒魔法伤害: 70/115/160/205/250 (+0.8 AP)
            float[] dpsDamage = { 70f, 115f, 160f, 205f, 250f };
            ...
            AddParticle(owner, owner, "RumbleQ_cas", targetPos);
        }
    }
}
