...
namespace Spells
{
    ...
    /// 发射四发超级子弹
    /// </summary>
    public class JhinR : ISpellScript
    {
        ...
        public void OnSpellPostCast(Spell spell)
        {
            ...
            foreach (var unit in GetUnitsInRange(targetPos, 600f, true))
            {
            ...
            AddParticle(owner, owner, "JhinR_cas", targetPos);
        }
    }
}
