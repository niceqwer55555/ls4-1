...
{
    /// <summary>
    /// Pyke E - Phantom Undertow
    /// 位移并在身后留下陷阱
    /// </summary>
    public class PykeE : ISpellScript
    {
        ...
        public void OnSpellPostCast(Spell spell)
        {
            ...
            // 物理伤害: 90/130/170/210/250 (+0.6 bonus AD)
            float[] baseDamage = { 90f, 130f, 170f, 210f, 250f };
            ...
            AddParticle(owner, owner, "PykeE_cas", targetPos);
        }
    }
}
