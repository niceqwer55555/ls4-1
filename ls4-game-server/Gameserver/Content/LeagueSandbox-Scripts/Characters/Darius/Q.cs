...
namespace Spells
{
    public class DariusCleave : ISpellScript
    {
        ...
        public void TargetExecute(Spell spell, AttackableUnit target, SpellMissile missile, SpellSector sector)
        {
            ...
            float[] baseDamage = { 10f, 25f, 40f, 55f, 70f };
            float[] adRatios = { 0.6f, 0.675f, 0.75f, 0.825f, 0.9f };
            int level = Darius.Spells[0].CastInfo.SpellLevel - 1;
            Damage = baseDamage[level] + (Darius.Stats.AttackDamage.Total * adRatios[level]);
